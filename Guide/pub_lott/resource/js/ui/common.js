...
var hanaUI = {
    ...
    inputField : function(obj){
        ...
        function util(){
            $clear.on({
                ...
                'click' : function(e){
                    console.log($(this).closest($el).find('.input__element').val())
    ...
    *****************************/
    ...
    sliderStack1 : function(obj){
        ...
        function event(){
            $obj.off('touchmove.sliderStack1').on('touchmove.sliderStack1', function(e){
                e.stopPropagation();
            })
            swipe();
            page();
        ...
        function page(){
            $indicator.off('click.sliderStack1', 'button').on('click.sliderStack1', 'button',function(e){
    ...
    sliderStack2 : function(obj){
        ...
        function event(){
            $obj.off('touchmove.sliderStack2').on('touchmove.sliderStack2', function(e){
                e.stopPropagation();
            })
            swipe();
            page();
        ...
        function page(){
            $indicator.off('click.sliderStack2', 'button').on('click.sliderStack2', 'button',function(e){
                var $parent = $(this).parent();
                active = $parent.index();
