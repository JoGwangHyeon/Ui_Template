	...
	var worklist = (function(){
		...
		*/
		var rMap ={
			...
			, activeTabNum = rMap.tab_navList.size()
			, guideTabNum = rMap.tab_navList.size()-1 //가이드 링크
			, allTabNum = rMap.tab_navList.size()-1 //전체 보기
		...
		var Filter =(function(){
			...
			function calculator_cate(){
				...
				$('.info_calc').each(function(){
					...
					$(this).html(resultNum + ' / ' + '<strong style="color:#666">'+totalNum +'</strong> = ' + percent + '%');
				});
			}
